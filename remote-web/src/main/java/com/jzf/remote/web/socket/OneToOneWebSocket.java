...
import com.jzf.remote.web.model.dto.WebSocketMessageDTO;
...
public class OneToOneWebSocket {
    ...
    public void onMessage(String message, Session session) {
        ...
        try {
            WebSocketMessageDTO myMessage = JSON.parseObject(message, WebSocketMessageDTO.class);
            if (myMessage != null) {
                Session toSession = clients.get(myMessage.getSessionId());
                if (toSession != null) {
